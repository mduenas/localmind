...
ARCHIVE_PATH="${TMPDIR:-/tmp}/localmind-${STAMP}.xcarchive"
EXPORT_PATH="${TMPDIR:-/tmp}/localmind-${STAMP}-export"
EXPORT_OPTIONS="${TMPDIR:-/tmp}/localmind-${STAMP}-ExportOptions.plist"
